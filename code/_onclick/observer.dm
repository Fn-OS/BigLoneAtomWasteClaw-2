...
/mob/dead/observer/proc/quickicspawn(mob/user)
	if(isobserver(user) && check_rights(R_SPAWN))
		...
		outfits["Legate - Legion"] = /datum/outfit/job/CaesarsLegion/Legionary/f13legate
		outfits["Colonel - NCR"] = /datum/outfit/job/ncr/f13colonel
		outfits["Elder - BoS"] = /datum/outfit/job/bos/f13elder
		outfits["Captain - Enclave"] = /datum/outfit/job/enclave/peacekeeper/enclavecpt
